...
router.post('/api/v1/auth/shippingAddress/new', validateAuth, [
    body('clientId')
        .trim()
        .notEmpty()
    ...
    const { countryCode, stateCode, cityId, firstName, lastName, street, zip } = req.body;
...
export { router as newShippingAddressRouter };